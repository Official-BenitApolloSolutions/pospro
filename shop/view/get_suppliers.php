        ...
        <tr>
            ...
            <td>
              <div class="d-flex justify-content-between m-2">
                <a href="../view/editsupplier_view.php?user_role=<?php echo $user_role ?>&supplier_id=<?php echo $row['supplier_id']; ?>" class="btn btn-outline-warning text-capitalize">edit</a>
              </div>
            </td>
        </tr>
      <?php } ?>
