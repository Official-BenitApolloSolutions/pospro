...
<head>
    ...
    <title>Current Report · POS v5.3</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/album/">
    <link href="../../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    <meta name="theme-color" content="#712cf9">
    <link rel="stylesheet" href="../../assets/css/custom-styles.css"> <!-- External CSS -->
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4>About</h4>
                        <p class="text-body-secondary">Point of sale current report </p>
                    </div>
        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">Current Report</h1>
    ...
    <footer class="text-body-secondary py-5">
        <div class="container">
            ...
            <p class="mb-1">Current report is &copy; Bootstrap, but please download and customize it for yourself!</p>
